...
|behavior.pruneDanglingMarkhorSecrets|boolean|True|If enabled, Markhor will delete all the Secrets which do not have a corresponding MarkhorSecret|
...
TODOs (help very much appreciated 🐜):
 - Honoring all the config values ❌
 - Docs ❌
